declare module "@simpleview/react-phone-input-2" {
  ...
  export interface PhoneInputProps<T extends HTMLElement = HTMLElement> extends PhoneInputEventsProps, Style, Components<T> {
